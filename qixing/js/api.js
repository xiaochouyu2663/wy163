	                            ...
	                            success:function (data) {
	                                if(data.result=="SUCCESS"){
	                                    ...
	                                    $.ajax({
	                                        ...
	                                        data:{uid:data.userid},
	                                        success:function(){
	                                            location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx9161959d6c078a3c&redirect_uri=http://wechat.trtjklife.com/php/customer-regsuccess.php&response_type=code&scope=snsapi_base&state=123#wechat_redirect';
	                                        }
	                                    })  
	                                }
                            	}
	                            ...
	                            success:function (data) {
	                                ...
	                                if(data.result=="SUCCESS"){
	                                    ...
	                                    $.ajax({
	                                        ...
	                                        data:{uid:data.userid},
	                                        success:function(){
	                                            location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx9161959d6c078a3c&redirect_uri=http://wechat.trtjklife.com/php/dealer-regsuccess.php&response_type=code&scope=snsapi_base&state=123#wechat_redirect';
	                                        }
	                                    })  
	                                }
                            	}

...
<body style="background: #f0f0f0">
    ...
    <div class="dialog-wraper" style="display: none">
        <div class="dialog-content" style="display:block">
            新密码已发送至手机<br>
            请<a class="go_log" href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx9161959d6c078a3c&redirect_uri=http://wechat.trtjklife.com/php/getOpenid.php&response_type=code&scope=snsapi_base&state=123#wechat_redirect">登录</a>
        </div>
    </div>

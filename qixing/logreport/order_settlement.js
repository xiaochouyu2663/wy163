...
var createOrder={
                    ...
                    WeixinJSBridge.invoke(
                        ...
                        function(res){
                            ...
                            if (msg == "get_brand_wcpay_request:ok") { 
                                ...
                                // alert(oid);
                                // alert(orderMoney);
                                createOrder.cashPayCall(user_id,oid,orderMoney) 
                            }else { 
    ...
    cashPayCall:function(user_id,oid,AMOUNT){
        $.ajax({
            url:"../controller/getContent.php",
            type:'get',
            data:{
                trigger:'',
                user_id:user_id,
                oid:oid,
                formData:JSON.stringify([{"AMOUNT":AMOUNT}])
            },
            dataType:'json',
            success:function(res){

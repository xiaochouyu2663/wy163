...
<body style="background: #f1f1f1">
    ...
    <div class="dealer-reg">
    	<div class="input-group">
    		<label for="refree-name">推荐人姓名</label>
    		<input type="text" id="refree-name" placeholder="推荐人姓名">
    	</div>
    	<div class="input-group">
    		<label for="member-numb">会员号</label>
    		<input type="text" id="member-numb" placeholder="推荐人会员号">
    	</div>
    	<div class="input-group">
    	...
    	<div class="input-group">
    		...
    		<input type="password" id="loginPwd" placeholder="请设置登录密码">
    	</div>
    	<div class="input-group">
    		<label for="loginPwd2">确认密码</label>
    		<input type="password" id="loginPwd2" placeholder="请再次输入登录密码">
    	</div>
    	<div class="read-protocol">
    		...
    		<span class="agree-content">
    			我已阅读并同意
    			<a href="protocol1.php" class="protocol-content">《优惠顾客注册协议》</a>
    		</span>
    	</div>

<?php
    ...
    if (!isset($_SESSION['uid'])){     
        setcookie('urlValue','upgrade.php'); 
...
<body>
    ...
    <div class="footer">
        ...
        <div class="integral">
            ...
            <p><span class="total">总积分:</span><span class="sum">&nbsp;&nbsp;&nbsp;<span id="integralSum">0</span></span></p>
        </div>
...
<script>
    ...
    if(productCar['productType']){
        var currentOrder=productCar['orderType']['order_type_id']
        var activeItem=productCar['productType']['product_id'];
        var currentProd=productCar['productInfo'];
        var userCurrent=productCar['userType'];
    }
    VIP(userCurrent);
    ...
    $('#settlement').click(function(){
        ...
        if(currentOrderType==JMOrderTrigger){
            var productStr="";

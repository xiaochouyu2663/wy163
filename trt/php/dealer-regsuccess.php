     ...
     <script>
        $(function(){
            ...
            $(".recommend_customer").click(function(){
                window.location.href="http://qixingshangcheng.pstech360.com/php/getScanCode.php?level=0"
            })
            $(".recommend_dealer").click(function(){
                window.location.href="http://qixingshangcheng.pstech360.com/php/getScanCode.php?level=1"
            })
        })
    </script>
</body>
